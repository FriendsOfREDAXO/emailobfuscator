	...
	if (!rex::isBackend()) {
		...
		rex_extension::register('OUTPUT_FILTER',function(rex_extension_point $ep) {
			...
			if (!in_array(rex_article::getCurrent()->getTemplateId(), $whitelistTemplates) && !in_array(rex_article::getCurrentId(), $whitelistArticles)) {
				...
				// Anmerkung: Attributwerte (hier: href) benˆtigen nicht zwingend Anf¸hrungsstriche drumrum,
				// deshalb pr¸fen wir zus‰tzlich noch auf '>' am Ende .
				...
				// Injiziere CSS vors schlieﬂende </head> im Seitenkopf
				...
				// Injiziere JavaScript vors schlieﬂende </body> der Seite
